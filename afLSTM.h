...
#ifndef TENSORFLOW_LITE_UTIL_AFLSTM_DATA_H_
#define TENSORFLOW_LITE_UTIL_AFLSTM_DATA_H_

extern const unsigned char afLSTM[];
extern const int afLSTM_len;

#endif  // TENSORFLOW_LITE_UTIL_AFLSTM_DATA_H_
